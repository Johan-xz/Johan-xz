<h1 align="center">Hi, I'm Johan Gloria 👋</h1>

<p align="center">
  <b>Software Engineer · Full-Stack Developer · AI/ML Enthusiast</b><br/>
  📍 Monterrey, Nuevo León, México &nbsp;|&nbsp; 🎓 UANL Software Engineering · Class of 2025
</p>
...
| Metric | Result |
|---|---|
| 📦 Online order fulfillment rate | **82% → 98.5%** (top-rated branch in NL) |
| 📉 Inventory loss reduction | **66% fewer losses** (6,000 → 2,000 units) |
| 🤖 ML competitions | Kaggle + 2× Datathon (OXXO & Hey Banco) |
| 🏗️ LLM deployment | RAG pipeline connected to LLM for financial coaching |

---

## 💡 Interests

`Software architecture` · `AI applications` · `Continuous learning` · `Psychology & neurology` · `Music` · `Problem solving`

---

<p align="center">
  <i>Open to Backend, Data Science, ML Engineering, and DevOps opportunities · Monterrey, NL & remote</i>
</p>
